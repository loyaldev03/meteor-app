module SacMailchimp
    ...
    def save!(club)
      ...
      elsif SacMailchimp::ProspectModel.email_belongs_to_prospect?(subscriber["data"].first["email"], club_id)
        begin
    ...
    def self.email_belongs_to_prospect?(email, club_id)
      Prospect.find_by_email_and_club_id(email, club_id)
    end
