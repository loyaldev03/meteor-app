module SacMailchimp
    ...
    module InstanceMethods
      ...
      def mailchimp_sync_to_remote_domain!
        ...
        Auditory.report_issue("Member:mailchimp_sync", e, { :member => self.inspect }) if not e.to_s.include?("Timeout") and not SacMailchimp::NO_REPORTABLE_ERRORS.include? e.code
        raise e
      end
