SacPlatform::Application.routes.draw do
  ...
  namespace :api do
    scope 'v1' do
      ...
      match 'members/report/get_updated' => 'members#get_updated', as: 'get_updated', :via => [:get]
      match 'members/report/get_created' => 'members#get_updated', as: 'get_updated', :via => [:get]
