class CreditCard < ActiveRecord::Base
  ...
  def get_offset_related
    Time.now.in_time_zone(self.member.club.time_zone).formatted_offset
  end
  ...
  def update_expire(year, month, current_agent = nil)
    ...
    elsif Time.new(year, month, nil, nil, nil, nil, get_offset_related) >= Time.now.in_time_zone(self.member.club.time_zone).beginning_of_month
