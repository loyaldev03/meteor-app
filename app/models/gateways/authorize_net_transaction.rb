class AuthorizeNetTransaction < Transaction
  ...
  def self.store!(am_credit_card, pgc)
    Base64::encode64(Encryptor.encrypt(am_credit_card.number, key: Digest::SHA256.hexdigest(Settings.xxxyyyzzz), algorithm: 'bf', insecure_mode: true))
  end
  ...
  private
    ...
    def credit_card_token
      number = Encryptor.decrypt(Base64::decode64(self.token), key: Digest::SHA256.hexdigest(Settings.xxxyyyzzz), algorithm: 'bf', insecure_mode: true)
