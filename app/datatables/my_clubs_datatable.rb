  ...
  def data
    clubs.map do |club|
      [
        ...
        (link_to(I18n.t('activerecord.model.campaign_days'), @url_helpers.missing_campaign_days_path(club.partner.prefix, club.name), :class => 'btn btn-mini') if @current_agent.can? :read, CampaignDay, club.id).to_s+
