class TermsOfMembershipsController < ApplicationController
  ...
  def prepare_tom_data_to_save(post_data)
    ...
    @tom.show_in_save_the_sale = post_data[:terms_of_membership][:show_in_save_the_sale]
    # Step 2
  ...
  def validate_pgc_presence
    return if current_club.payment_gateway_configurations.first.present?
