    ...
    respond_to do |format|
      if credit_card.am_card.valid?
        if credit_card.save && actual_credit_card.deactivate
          ...
          format.html { redirect_to show_member_path(:id => @current_member), notice: "The Credit Card #{credit_card.last_digits} was successfully added and setted as active."  } 
        else
  ...
  def activate
    ...
    respond_to do |format|
      if new_credit_card.activate && former_credit_card.deactivate
        ...
        format.html { redirect_to show_member_path(:id => @current_member), notice: "The Credit Card #{new_credit_card.last_digits} was activated." }
      else
