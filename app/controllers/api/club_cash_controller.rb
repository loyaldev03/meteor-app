class Api::ClubCashController < ApplicationController
  ...
  # [amount] Amount of the club cash to add or It. deduct should be float and only number. We accept a maximun of two digits after the comma. (Example: 2.50 , -10.99, 25)
