class Api::MembersController < ApplicationController
  ...
  #     <li><strong>additional_data</strong> Data will be saved as a key:value pair in json format. This will contain any kind of additional data which may depend on the club where the member is enrolled. [optional]</li>
