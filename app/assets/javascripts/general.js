...
function transportSettingsFormFunctions() {
  ...
  function showSettingsPane(transport) {
    ...
    transport == "google_analytics" ? $("#transport_settings_values_google_analytics").show() : $("#transport_settings_values_google_analytics").hide();
    transport == "google_tag_manager" ? $("#transport_settings_values_google_tag_manager").show() : $("#transport_settings_values_google_tag_manager").hide();
  }
  ...
  function assignRequiredTagToFields(transport) {
    ...
    switch(transport) {
      ...
      case 'google_analytics':
        $('#transport_setting_tracking_id').prop('required', true);
        break;
      case 'google_tag_manager':
        $('#transport_setting_container_id').prop('required', true);
        break;
    }
  }
