FactoryBot.define do
  factory :club do
    sequence(:name) { "club_#{Faker::Lorem.characters(10)}" }
    cs_phone_number { '123 456 7891' }
    cs_email { 'customer_service@example.com' }
    time_zone { 'Eastern Time (US & Canada)' } # or configure TZInfo::Timezone.all.sample.name
  ...
  factory :simple_club_with_litle_gateway, class: Club do
    sequence(:name) { "simple_club_with_litle_gateway_#{Faker::Lorem.characters(10)}" }
    description { 'My description' }
    cs_phone_number { '123 456 7891' }
    cs_email { 'customer_service@example.com' }
    billing_enable { true }
  ...
  factory :simple_club_with_authorize_net_gateway, class: Club do
    sequence(:name) { "simple_club_with_authorize_net_gateway_#{Faker::Lorem.characters(10)}" }
    description { 'My description' }
    cs_phone_number { '123 456 7891' }
    cs_email { 'customer_service@example.com' }
    billing_enable { true }
  ...
  factory :simple_club_with_first_data_gateway, class: Club do
    sequence(:name) { "simple_club_with_first_data_gateway_#{Faker::Lorem.characters(10)}" }
    description { 'My description' }
    cs_phone_number { '123 456 7891' }
    cs_email { 'customer_service@example.com' }
    billing_enable { true }
  ...
  factory :simple_club_with_stripe_gateway, class: Club do
    sequence(:name) { "simple_club_with_stripe_gateway_#{Faker::Lorem.characters(10)}" }
    description { 'My description' }
    cs_phone_number { '123 456 7891' }
    cs_email { 'customer_service@example.com' }
    billing_enable { true }
  ...
  factory :simple_club_with_gateway_with_family, class: Club do
    sequence(:name) { "simple_club_with_gateway_with_family_#{Faker::Lorem.characters(10)}" }
    description { 'My description' }
    cs_phone_number { '123 456 7891' }
    cs_email { 'customer_service@example.com' }
    billing_enable { true }
  ...
  factory :club_with_api, class: Club do
    sequence(:name) { "club_with_api_#{Faker::Lorem.characters(10)}" }
    description { 'My description' }
    cs_phone_number { '123 456 7891' }
    cs_email { 'customer_service@example.com' }
    billing_enable { true }
  ...
  factory :club_with_wordpress_api, class: Club do
    sequence(:name) { "club_with_wordpress_api_#{Faker::Lorem.characters(10)}" }
    description { 'My description' }
    cs_phone_number { '123 456 7891' }
    cs_email { 'customer_service@example.com' }
    billing_enable { true }
  ...
  factory :club_with_gateway, class: Club do
    sequence(:name) { "club_with_gateway_#{Faker::Lorem.characters(10)}" }
    time_zone { 'Eastern Time (US & Canada)' } # or configure TZInfo::Timezone.all.sample.name
    description { 'My description' }
    cs_phone_number { '123 456 7891' }
    cs_email { 'customer_service@example.com' }
  ...
  factory :simple_club_with_require_external_id, class: Club do
    sequence(:name) { "simple_club_with_require_external_id_#{Faker::Lorem.characters(10)}" }
    description { 'My description' }
    cs_phone_number { '123 456 7891' }
    cs_email { 'customer_service@example.com' }
    billing_enable { true }
  ...
  factory :club_with_mkt_client_mailchimp, parent: :simple_club_with_gateway do
    marketing_tool_client { 'mailchimp_mandrill' }
    marketing_tool_attributes { { 'mandrill_api_key' => 'dy-jfwcFJDHqX_UuOk_ABC', 'mailchimp_api_key' => '1234fe03a73eca71d665c241deefeb3e-us8', 'mailchimp_list_id' => 'd38bcbABBB' } }
  end
end
