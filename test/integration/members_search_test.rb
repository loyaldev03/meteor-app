...
class MembersSearchTest < ActionController::IntegrationTest
  ...
  # TODO: refactor this test. Create one test "go from member index to edit member's" something general. And create
  # one test that validates that "edit member's phone number to a wrong phone number" without using search 
