...
class TransportSettingsTest < ActionDispatch::IntegrationTest
  ...
  def fill_in_form(transport = nil, options = {})
    select transport, from: 'transport_setting[transport]' unless transport.nil?
  ...
  test 'should see Facebook Transport Settings' do
    FactoryBot.create(:transport_settings_facebook, club_id: @club.id)
  ...
  test 'should create Facebook, Mailchimp, Google Tag Manager, Google Analytics and Store Transport Settings' do
    ...
    fill_in_form('Facebook', client_id: @tsfacebook.client_id, client_secret: @tsfacebook.client_secret, access_token: @tsfacebook.access_token)
    ...
    click_link_or_button 'Back'
    click_link_or_button 'new_transport_setting'
    fill_in_form('Google Tag Manager', container_id: @tsgoogletagmanager.container_id)
    click_link_or_button 'Create Transport setting'
    ...
    click_link_or_button 'Back'
    click_link_or_button 'new_transport_setting'
    fill_in_form('Google Analytics', tracking_id: @tsgoogleanalytics.tracking_id)
    click_link_or_button 'Create Transport setting'
    ...
    click_link_or_button 'Back'
    click_link_or_button 'new_transport_setting'
    fill_in_form('Store', url: @tsstore.url, api_token: @tsstore.api_token)
    click_link_or_button 'Create Transport setting'
  ...
  test 'should see Mailchimp Transport Settings' do
    FactoryBot.create(:transport_settings_mailchimp, club_id: @club.id)
    visit transport_settings_path(@partner_prefix, @club.name)
    within('#transport_settings_table') do
      click_link_or_button 'Show'
    end
  ...
  test 'should see Google tag manager Transport Settings' do
    FactoryBot.create(:transport_settings_google_tag_manager, club_id: @club.id)
    visit transport_settings_path(@partner_prefix, @club.name)
    within('#transport_settings_table') do
      click_link_or_button 'Show'
    end
  ...
  test 'should see Google analytics Transport Settings' do
    FactoryBot.create(:transport_settings_google_analytics, club_id: @club.id)
    visit transport_settings_path(@partner_prefix, @club.name)
    within('#transport_settings_table') do
      click_link_or_button 'Show'
    end
