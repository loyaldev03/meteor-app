...
# is_payment_expected = nil, suscription_terms = nil, trial_period_lasting_time = "Day(s)", installment_amount_days_time = "Day(s)", suscription_terms_stop_billing_after_time = "Day(s)"
	# # # NEW
 ...
 #    within("#td_mi_club_cash_amount") { assert page.has_content?(amount_of_club_cash) }
	...
	test "Update subcription plan with Paid Trial Period by days - No membership associated" do
		...
		fill_in_step_1(tom_name + ' Updated')
		click_link_or_button 'Edit Membership Terms'
		fill_in_step_2({initial_fee_amount:10, trial_period_amount:20, trial_period_lasting:10, installment_amount:10, installment_amount_days:1},{trial_period_lasting_time_span:"Days(s)"},["is_payment_expected_yes","suscription_terms_until_cancelled"])
		click_link_or_button 'Edit Upgrades / Downgrades'
