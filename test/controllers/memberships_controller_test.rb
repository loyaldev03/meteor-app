...
class MembershipsControllerTest < ActionController::TestCase
  ...
  test 'allows to get list of memberships' do
  ...
  test 'does not allow to get list of memberships' do
  ...
  test 'allows to get list of club cash memberships' do
  ...
  test 'does allows to get list of memberships by club role from other club' do
    %w[admin supervisor representative  agency fulfillment_managment].each do |role|
  ...
  test 'does not allow to get list of memberships by club role' do
