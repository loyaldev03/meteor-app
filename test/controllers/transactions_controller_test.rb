...
class TransactionsControllerTest < ActionController::TestCase
  ...
  test 'allows to get list of transactions' do
  ...
  test 'does not allow to get list of transactions' do
  ...
  test 'does allows to get list of transactions by club role from other club' do
    %w[admin supervisor representative  agency fulfillment_managment].each do |role|
  ...
  test 'does not allow to get list of transactions by club role' do
