...
[ 'didn’t know I enrolled' ,  'can’t afford' ,  'Did not use benefits' ,  'did not want' , 
  'only wanted product', 'can’t afford now (possible future call back)', 'CHARGEBACK', 'others' ].each do |name|
